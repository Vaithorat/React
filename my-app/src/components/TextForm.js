  ...
  return (
    ...
    <div className = "container" style = {{color: props.mode === "dark" ? "white" : "black"}}>
      ...
      <div className="mb-3">
        ...
        style = {{backgroundColor: props.mode === "dark" ? "#121212" : "#ffffff",color: props.mode === "dark" ? "white" : "black"}}
    ...
    <div className="container my-2" style = {{color: props.mode === "dark" ? "white" : "black"}}> {/* my-2 adds margin of 2 */}
      <h2>Text Summary</h2>
